...
- **Notion:** extends 03b (Recommendation Flow & Card Contract) · 08b-2 (Assembly Prompt) · 08b (Conversation Agent). **Phase:** post-v1 robustness. **Status:** SPEC (proposed; build PENDING founder confirm).
